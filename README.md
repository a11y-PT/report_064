---
website: "Portal das Bolsas de Estudo de Câmara de Lobos"          # Entre as aspas escreve o nome do website
date: "15/05/2026"                    # Entre as aspas escreve a data de criação do 1º relatório. Os restantes estão no histórico
uri: "https://bolsadeestudo.cm-camaradelobos.pt"   # Entre as aspas escreve o domínio do website
a11y_statement: "https://bolsadeestudo.cm-camaradelobos.pt/acessibilidade" # Entre as aspas escreve o URL da Declaração de Acessibilidade do website
